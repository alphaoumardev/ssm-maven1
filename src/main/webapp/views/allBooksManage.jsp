...
<table id="dg" title="书籍信息管理" class="easyui-datagrid" pagination="true"
    ...
    <tr>
        ...
        <th align="center" field="id" hidden="true" width="10">编号</th>
...
<div id="tb">
    <div>
        &nbsp;标题：&nbsp;<label for="biaoti"></label><input type="text" id="biaoti" size="20"
                                                          onkeydown="if(event.keyCode===13) searchBook()"/>&nbsp;&nbsp;作者：&nbsp;<input
            type="text" id="zuozhe" size="20"
            onkeydown="if(event.keyCode===13) searchBook()"/>&nbsp;
        &nbsp;ISBN码：&nbsp;<label for="bianma"></label><input type="text" id="bianma" size="20"
...
<div id="dlg_c" class="easyui-dialog"
    ...
    <form id="fm_c" method="post" action="">
...
<script type="text/javascript">
    ...
    function formatProPic(val, row) {
        return "<img alt='alpha' width=80 height=110 src='../" + val + "'>";
    }
